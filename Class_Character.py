...
silent_takedown=attack('Silent Takedown','Stealth behind the enemy and attack.',0,0,'\033[0m')
silent_takedown2=attack('Silent Takedown','Stealth behind the enemy and attack.',0,0,'\033[0m')
ryuu=attack('Ryuu','Strike like a dragon.',0,0,'\033[0m')
ryuu2=attack('Ryuu','Strike like a dragon.',0,0,'\033[0m')
